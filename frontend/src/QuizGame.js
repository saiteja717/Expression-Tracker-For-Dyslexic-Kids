...
//   const [showConfetti, setShowConfetti] = useState(false);
//   const [backgroundColor, setBackgroundColor] = useState('default');
//   const [isAnswered, setIsAnswered] = useState(false); // Added state variable
...
//   const handleNextQuestion = () => {
//     setBackgroundColor('default');
//     setIsAnswered(false); // Reset on next question
//     if (currentQuestion < quizData.length - 1) {
//       setCurrentQuestion(currentQuestion + 1);
//       setTimeLeft(30);
//     } else {
      ...
      <div className="quiz">
        ...
        {showScore ? (
          <div className="score-section">
            <h1>🎉 Congratulations {playerName}! 🎉</h1>
            <h2>Your Score: {score} / {quizData.length}</h2>
            <button onClick={handleGoHome}>Go to Home Page</button> {/* Navigate to home page */}
          </div>
        ) : (
          <>
            <div className="progress-bar">
